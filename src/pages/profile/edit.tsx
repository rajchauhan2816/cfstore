...
const ProfileEditor = () => {
  ...
  const handleFormSubmit = async (values) => {
    console.log(values);
    dispatch(updateUser({ firstName: values.first_name, lastName: values.last_name }));
  };
  const { user: { firstName, lastName, mobile } } = useAppSelector((store) => store.auth);


  initialValues.first_name = firstName;
  initialValues.last_name = lastName;
  initialValues.contact = mobile;
    ...
    <div>
      ...
      <Card1>
        <FlexBox alignItems="flex-end" mb="22px">
          <Avatar src="/assets/images/avatars/001-man.svg" size={64} />
